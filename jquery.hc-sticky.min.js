...
var u=function(d){b.hasClass(a.className)||(d=d||{},b.css({position:"fixed",top:d.top||0,left:d.left||e.offset().left}).addClass(a.className),a.onStart.apply(b[0]))},w=function(d){d=d||{};d.position=d.position||"absolute";d.top=d.top||0;d.left=d.left||0;if("fixed"==b.css("position")||parseInt(b.css("top"))!=d.top)b.css({position:d.position,top:d.top,left:d.left}).removeClass(a.className),a.onStop.apply(b[0])},x=!1,m=!1,A=function(){y();z();var d=function(){"fixed"==b.css("position")?b.css("left",
